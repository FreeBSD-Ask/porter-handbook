...
>**重要**
>
>为了将 flavor 与总是使用大写字母的选项区分开来，flavor 名称*只能*包含小写字母、数字和下划线 `_`。
