...
为易于移植且以二进制形式分发的 Electron 应用程序提供支持。根据使用的参数，添加对 [devel/electron31](https://cgit.freebsd.org/ports/tree/devel/electron31/)，[devel/electron32](https://cgit.freebsd.org/ports/tree/devel/electron32/)，或 [devel/electron33](https://cgit.freebsd.org/ports/tree/devel/electron33/) 的构建和运行时依赖。
