...
* [5.5.监护人（MAINTAINER）](di-5-zhang-pei-zhi-makefile/5.5.-jian-hu-ren-maintainer.md)
...
* [5.12.Info文件](di-5-zhang-pei-zhi-makefile/5.12.info-wen-jian.md)
...
* [8.3.pkg-deinstall (卸载时执行的脚本文件)](di-9-zhang-pkg/8.3.pkgdeinstall-xie-zai-shi-zhi-hang-de-jiao-ben-wen-jian.md)
