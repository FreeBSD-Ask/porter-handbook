...
| 值 | 修订版 | 日期 | 版本 |
| --- | --- | --- | --- |
| 800000	 | [172531](https://svnweb.freebsd.org/changeset/base/172531)	 | 2007.10.11	 | 8.0-CURRENT. 分开广义和单字节的 ctype。 |
...
| 801501	 | [214762](https://svnweb.freebsd.org/changeset/base/214762)	 | 2010.11.03 	 | 修改了 struct sysentvec 中的 KBI， 并实现了 PL_FLAG_SCE/SCX/EXEC/SI 和 pl_siginfo for ptrace(PT_LWPINFO) 之后的 8.1-STABLE。 |
