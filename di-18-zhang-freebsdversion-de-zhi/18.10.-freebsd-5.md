...
| 500010	 | [63265](https://svnweb.freebsd.org/changeset/base/63265)	 | 2000.07.16 	 | 将 mtree 默认值改回原始变量之后的 5.0-CURRENT，加入了 -L 以跟踪符号链接。 |
...
| 500015	 | [70894](https://svnweb.freebsd.org/changeset/base/70894)	 | 2001.01.10	 | 将 libgcc.a 和 libgcc_r.a 合并后的 5.0-CURRENT， 以及相关的 GCC 连接变化。 |
...
| 500021	 | [78632](https://svnweb.freebsd.org/changeset/base/78632)	 | 2001.06.22	 | 导入 Bzip2 之后的 5.0-CURRENT。也标志着取消了 S/Key。 |
...
| 500025	 | [84481](https://svnweb.freebsd.org/changeset/base/84481)	 | 2001.10.04	 | 64 位平台上描述符和信条传递的 ABI 改变之后的 5.0-CURRENT。 |
| 500026	 | [84710](https://svnweb.freebsd.org/changeset/base/84710)	 | 2001.10.09	 | 将软件包的构建默认为 XFree86 4， 并加入新的 libc `strnstr()` 函数之后的 5.0-CURRENT。 |
| 500027	 | [84743](https://svnweb.freebsd.org/changeset/base/84743)	 | 2001.10.10	 | 加入新的 libc `strcasestr()` 函数之后的 5.0-CURRENT。 |
| 500028	 | [87879](https://svnweb.freebsd.org/changeset/base/87879)	 | 2001.12.14	 | 输入了 smbfs 的用户区组件之后的 5.0-CURRENT。 |
...
| 502114	 | [130418](https://svnweb.freebsd.org/changeset/base/130418)	 | 2004.6.13	 | 引入 ALTQ 框架之后的 5.2-CURRENT。 |
| 502115	 | [130481](https://svnweb.freebsd.org/changeset/base/130481)	 | 2004.6.14	 | 将 [sema_timedwait(9)](https://www.freebsd.org/cgi/man.cgi?query=sema_timedwait&sektion=9&format=html) 改为成功时返回 0，失败时返回非零错误代码之后的 5.2-CURRENT。 |
