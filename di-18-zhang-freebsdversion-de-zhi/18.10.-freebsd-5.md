...
| 502123	 | [132025](https://svnweb.freebsd.org/changeset/base/132025)	 | 2004.07.12	 | 在更改使 VFS_ROOT 像 vflush 一样采用结构线程参数之后的 5.2-CURRENT。kinfo_proc 结构现在有了一个用户数据指针。这时还将默认的 X 实现切换为 `xorg`。 |
...
| 503104	 | [142835](https://svnweb.freebsd.org/changeset/base/142835)	 | 2005.02.28	 | 在将 ifi_epoch 从挂钟时间改为 uptime 的 MFC 之后 5.4-PRERELEASE。 |
