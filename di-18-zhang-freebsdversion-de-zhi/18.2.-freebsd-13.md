...
|    1300013    |  [344300](https://svnweb.freebsd.org/changeset/base/344300)  | 2019.02.19 | 13.0- 删除 drm 和 drm2 之后的电流。 |
...
|    1300025    |  [347532](https://svnweb.freebsd.org/changeset/base/347532)  |    2019.05.13    | 13.0-CURRENT 在重命名为并改变其类型后，`vm.max_wired` `vm.max_user_wired`。 |
...
|    1300032    |  [349151](https://svnweb.freebsd.org/changeset/base/349151)  | 2019.06.17 | 将内核的实现分离到自己的头文件（**gsb_crc32.h**），并将源代码改名为**gsb_crc32.c**.`crc32()`之后的13.0-CURRENT。 |
|    1300033    |  [349277](https://svnweb.freebsd.org/changeset/base/349277)  | 2019.06.21 | 13.0-CURRENT  在 LinuxKPI 的列表中添加了 `rcu`。 |
|    1300034    |  [349352](https://svnweb.freebsd.org/changeset/base/349352)  | 2019.06.24 | 13.0-去除 NAND 和 NANDFS 之后的电流。 |
...
|    1300043    |  [351698](https://svnweb.freebsd.org/changeset/base/351698)  | 2019.09.02 | 13.0-剔除 [get(3)](https://www.freebsd.org/cgi/man.cgi?query=gets&sektion=3&format=html) 后的电流。 |
...
|    1300052    |  [353698](https://svnweb.freebsd.org/changeset/base/353698)  |  2019.10.17  | 13.0-CURRENT 在将页忙字段提升为第一类锁后，不再需要对象锁的一致性。 |
...
|    1300060    |  [354922](https://svnweb.freebsd.org/changeset/base/354922)  | 2019.11.20 | 将**/etc/os-release**作为符号链接添加到**/var/run/os-release**后的13.0-CURRENT。 |
...
|    1300066    |  [355679](https://svnweb.freebsd.org/changeset/base/355679)  | 2019.12.12 | 作为引入 NFS 4.2 的一部分，改变了 NFS 模块之间的内部接口之后的 13.0-CURRENT。 |
...
|    1300072    |  [356185](https://svnweb.freebsd.org/changeset/base/356185)  | 2019.12.29 | 13.0-CURRENT 在删除了类和工具后。`GEOM_SCHED` `gsched`。 |
...
|    1300075    |  [356409](https://svnweb.freebsd.org/changeset/base/356409)  | 2020.01.06 | 13.0-CURRENT 在加入自己的计数器后，用于取消的 USB 传输。 |
...
|    1300078    |  [358020](https://svnweb.freebsd.org/changeset/base/358020)  | 2020.02.17 | 更改后的 13.0-CURRENT，以及 VNET 魔法 cookie.`struct vnet`。 |
...
|    1300081    |  [358218](https://svnweb.freebsd.org/changeset/base/358218)  | 2020.02.21 | 最近 linuxkpi 变化之后的 13.0-CURRENT。 |
|    1300082    |  [358497](https://svnweb.freebsd.org/changeset/base/358497)  | 2020.03.01 | 13.0-去除 [bktr(4)](https://www.freebsd.org/cgi/man.cgi?query=bktr&sektion=4&format=html) 后的电流。 |
...
|    1300089    |  [359727](https://svnweb.freebsd.org/changeset/base/359727)  | 2020.04.08 | 13.0-CURRENT 在 LinuxKPI 中把 RCU 接口克隆为可睡眠和不可睡眠的部分之后。 |
|    1300090    |  [359747](https://svnweb.freebsd.org/changeset/base/359747)  | 2020.04.09 | 13.0-CURRENT 在删除了使用 Giant 的旧 NFS 锁设备驱动程序之后。 |
...
|    1300095    |  [361275](https://svnweb.freebsd.org/changeset/base/361275)  |    2020.05.20    | 增加了对 FreeBSD 客座的 HyperV 套接字支持之后的 13.0-CURRENT。 |
...
|    1300098    |  [362159](https://svnweb.freebsd.org/changeset/base/362159)  | 2020.06.14 | 13.0-CURRENT在改变字段，使之成为64bits.`export_args ex_flags`之后。 |
...
|    1300103    |  [363757](https://svnweb.freebsd.org/changeset/base/363757)  |   2020.08.01   |  13.0-CURRENT 在对 NDINIT_ALL 进行强制权限之后。  |
|    1300104    |  [363783](https://svnweb.freebsd.org/changeset/base/363783)  |   2020.08.02   |           vnode 布局改变之后的 13.0-CURRENT。           |
|    1300105    |  [363894](https://svnweb.freebsd.org/changeset/base/363894)  |   2020.08.05   | 更改后的 13.0-CURRENT，`vaccess()`。 |
|    1300106    |  [364092](https://svnweb.freebsd.org/changeset/base/364092)  | 2020.08.11 | 13.0-CURRENT 在加入一个参数后，表示连接使用 TLS。`newnfs_connect()`。 |
|    1300107    |  [364109](https://svnweb.freebsd.org/changeset/base/364109)  | 2020.08.11 | 13.0-CURRENT  改为克隆与 RCU 有关的任务结构字段之后。 |
|    1300108    |  [364233](https://svnweb.freebsd.org/changeset/base/364233)  | 2020.08.14 | 在 linuxkpi 中增加了一些 wait_bit 函数之后的 13.0-CURRENT，这些函数是 Linux v5.4 的 DRM 所需要的。 |
|    1300109    |  [364274](https://svnweb.freebsd.org/changeset/base/364274)  | 2020.08.16 | 移除参数和更名标志后的 13.0-CURRENT。`vget()`。 |
...
|    1300110    |  [364331](https://svnweb.freebsd.org/changeset/base/364331)  | 2020.08.18 | 删去 .`use_ext` `nfscl_reqstart()`未使用的参数之后的 13.0-CURRENT。 |
|    1300111    |  [364476](https://svnweb.freebsd.org/changeset/base/364476)  | 2020.08.22 |   在内核 RPC 中增加 TLS 支持之后的 13.0-CURRENT。   |
|    1300112    |  [364747](https://svnweb.freebsd.org/changeset/base/364747)  | 2020.08.25 | 合并了 OpenZFS 支持之后的 13.0-CURRENT。 |
...
|    1300115    |  [365705](https://svnweb.freebsd.org/changeset/base/365705)  | 2020.09.14 | 修正了[crunchgen(1)](https://www.freebsd.org/cgi/man.cgi?query=crunchgen&sektion=1&format=html)应用程序建立时的.`WARNS=6`后的13.0-CURRENT。 |
|    1300116    |  [366062](https://svnweb.freebsd.org/changeset/base/366062)  | 2020.09.22 | powerpc64le ARCH 推出后的 13.0-CURRENT。 |
...
|    1300118    |  [366374](https://svnweb.freebsd.org/changeset/base/366374)  | 2020.10.02 | 为 linuxkpi.`mi_*`增加背光支持和功能之后的 13.0-CURRENT。 |
|    1300119    |  [366432](https://svnweb.freebsd.org/changeset/base/366432)  | 2020.10.06 | 在LinuxKPI.`ww_mutex`中填充了a的获取环境字段之后的13.0-CURRENT。 |
|    1300120    |  [366666](https://svnweb.freebsd.org/changeset/base/366666)  |  2020.10.13  |   修正了 arm64 只写的映射之后的 13.0-CURRENT。   |
|    1300121    |  [366719](https://svnweb.freebsd.org/changeset/base/366719)  |  2020.10.15  |       加入 `VOP_EAGAIN` 之后的 13.0-CURRENT。       |
|    1300122    |  [366782](https://svnweb.freebsd.org/changeset/base/366782)  |  2020.10.17  | 加入 `ptsname_r` 之后的 13.0-CURRENT。 |
|    1300123    |  [366871](https://svnweb.freebsd.org/changeset/base/366871)  |  2020.10.20  | 13.0-CURRENT之后，，和变化。`VOP` `VPTOCNP` `INACTIVE`。 |
|    1300124    |  [367162](https://svnweb.freebsd.org/changeset/base/367162)  |  2020.10.30  | 添加并重命名到.`cache_vop_mkdir` `cache_rename` `cache_vop_rename`后的13.0-CURRENT |
|    1300125    |  [367347](https://svnweb.freebsd.org/changeset/base/367347)  |  2020.11.04  | 在.`rms` `zfs`中使用锁进行拆解处理后的13.0-CURRENT |
|    1300126    |  [367384](https://svnweb.freebsd.org/changeset/base/367384)  |  2020.11.05  | 13.0-CURRENT 在合理化每台计算机区域之后。 |
|    1300127    |  [367432](https://svnweb.freebsd.org/changeset/base/367432)  |  2020.11.06  | 转入.`malloc_type_internal` `malloc_type`之后的13.0-CURRENT |
|    1300128    |  [367522](https://svnweb.freebsd.org/changeset/base/367522)  |  2020.11.09  | 13.0-CURRENT 在 LinuxKPI 中增加了基础系统所需的 ACPI 位，`drm-kmod`。 |
|    1300129    |  [367627](https://svnweb.freebsd.org/changeset/base/367627)  | 2020.11.12 | 淘汰 malloc_last_fail 之后的 13.0-CURRENT。 |
|    1300130    |  [367777](https://svnweb.freebsd.org/changeset/base/367777)  | 2020.11.17 | p_pd / pwddesc 从 p_fd / filedesc 拆分出来之后的 13.0-CURRENT。 |
|    1300131    |  [368417](https://svnweb.freebsd.org/changeset/base/368417)  |  2020.12.07  |    移除加密文件描述符之后的 13.0-CURRENT。    |
|    1300132    |  [368659](https://svnweb.freebsd.org/changeset/base/368659)  | 2020.12.15 | 13.0-CURRENT 在改进了对 USB 堆栈中交替设置的处理之后。 |
...
|    1300134    | [a84b0e94cdbf](https://cgit.freebsd.org/src/commit/?id=a84b0e94cdbf1a17a798ab7f77375aacb4d400ff) | 2021.01.07 | 13.0-CURRENT 是把支持 USB HID 的独立于硬件的部分计入一个新的模块之后的结果。 |
|    1300135    | [35a39dc5b349](https://cgit.freebsd.org/src/commit/?id=35a39dc5b34962081eeda8dbcf0b99a31585499b) |  2021.01.12  | 13.0-CURRENT after adding `kernel_fpu_begin`/`kernel_fpu_end` to the LinuxKPI. |
...
|    1300138    | [dcee9964238b](https://cgit.freebsd.org/src/commit/?id=dcee9964238b12a8e55917f292139f074b1a80b2) |  2021.02.01  | 13.0-ALPHA3 在为 vfs 缓存添加无锁符号链接查询后。 |
|    1300139    | [91a07ed50ffc](https://cgit.freebsd.org/src/commit/?id=91a07ed50ffca4dfada3e7f1f050ea746c1bac66) |  2021.02.02  | 13.0-ALPHA3 在添加各种 LinuxKPI 位后与 drm-kmod 冲突。 |
|    1300500    | [3c6a89748a01](https://cgit.freebsd.org/src/commit/?id=3c6a89748a01869c18955d5e3bfcdf35f6705d26) |  2021.02.05  | releng/13.0 被支解后的 13.0-STABLE。 |
...
|    1300502    | [da6a8ccfa293](https://cgit.freebsd.org/src/commit/?id=da6a8ccfa293c3c831fdde51169754fcb9587657) |   2021.04.23   | 13.0-STABLE 在 LinuxKPI 中实现了 `atomic_dec_and_lock_irqsave()` 之后。 |
|    1300503    | [d60c6dc8f69b](https://cgit.freebsd.org/src/commit/?id=d60c6dc8f69b1264c7af5e2479ea94f000fd2c6d) |   2021.04.23   | 13.0-STABLE 在改变了 krpc 和 NFS 之间的内部 KAPI 之后。 |
|    1300504    | [fb34817c686c](https://cgit.freebsd.org/src/commit/?id=fb34817c686cc130449325499870e36979899801) |   2021.04.30   | 13.0-STABLE 是在更新 LinuxKPI 以适应 drm-kmod 5.5 更新之后。 |
|    1300505    | [8f81f190a640](https://cgit.freebsd.org/src/commit/?id=8f81f190a640e211dd814bdde7811982b9491fb0) |    2021.05.10    | 13.0-STABLE 在 nscl.ko 和 nfscommon.ko 模块之间改变了内部 KAPI。 |
...
|    1300507    | [c64d1bd7145b](https://cgit.freebsd.org/src/commit/?id=c64d1bd7145b5d30c97d1cd99e584da529d95100) |    2021.06.02    | 13.0-STABLE 在 [EPOCH(9)](https://www.freebsd.org/cgi/man.cgi?query=EPOCH&sektion=9&format=html) 跟踪器结构中添加了一个新成员之后。 |
|    1300508    | [658f5eed38c3](https://cgit.freebsd.org/src/commit/?id=658f5eed38c35f3f7d6695110b7dae8dc94d12c7) | 2021.06.11 | 13.0-STABLE 在 LinuxKPI 中加入了 `might_lock_nested()` 和 `lockdep_(re/un/)pin_lock()` 的宏之后。 |
|    1300509    | [210349325af9](https://cgit.freebsd.org/src/commit/?id=210349325af9920d1535ad76fa3b92847684f6e0) | 2021.06.14 | 13.0-STABLE 在 LinuxKPI 中增加了一个宏，即`list_for_each_entry_lockless()`。 |
|    1300510    | [eb3397588e1b](https://cgit.freebsd.org/src/commit/?id=eb3397588e1b48043e166587ea454f60efea88d0) | 2021.06.26 | 13.0-STABLE 在改变了 krpc 和 nfsd 模块之间的内部 KAPI 之后。 |
|    1300511    | [2622570aeb3d](https://cgit.freebsd.org/src/commit/?id=2622570aeb3d162812d72f7ef192c322cd8b73ef) |    2021.07.07    | 13.0-STABLE 在改变为只在另一个线程在之前的prelink之后改变了vnode元数据时才做同步。`softdep_prelink()`。 |
|    1300512    | [f72db34d2295](https://cgit.freebsd.org/src/commit/?id=f72db34d2295080f57a283858125aa906c0d409e) | 2021.07.18 | 13.0-STABLE 在对 LinuxKPI、OFED、net80211 和驱动进行了各种合并之后。 |
...
|    1300514    | [53d162819c20](https://cgit.freebsd.org/src/commit/?id=53d162819c20e5cf267cb91f7a19940e96e8bec4) |   2021.08.03   | 对NFS之间的内部接口KBI的不兼容的改变需要重建模块。 |
...
|    1300518    | [a017868e2818](https://cgit.freebsd.org/src/commit/?id=a017868e281874261a560ba1e3069b4e14b7483e) |  2021.10.21  | 加入 .`crypto_cursor_segment()`后的 13.0-STABLE |
...
|    1300522    | [0c8684ae2001](https://cgit.freebsd.org/src/commit/?id=0c8684ae20019b63c6672cc9fa40e1426708b007) | 2021.11.24 | 13.0-STABLE 在 NFS 模块之间改变内部 KAPI 之后。 |
|    1300523    | [690bcf605d84](https://cgit.freebsd.org/src/commit/?id=690bcf605d84283c1f9d254885a3cac69c5e80a6) | 2021.12.18 | 13.0-STABLE 在 [VOP_ALLOCATE(9)](https://www.freebsd.org/cgi/man.cgi?query=VOP_ALLOCATE&sektion=9&format=html) 中加入了两个参数之后。 |
|    1300524    | [dc4114875ef1](https://cgit.freebsd.org/src/commit/?id=dc4114875ef10618002d3eeb46f09dc42da56b30) |  2022.01.14  | 13.0-STABLE 在使 CPU_SET 宏与 glibc 兼容之后。 |
|    1300525    | [dee0854a009c](https://cgit.freebsd.org/src/commit/?id=dee0854a009cde7dcdb16ba39754237737022c8a) |  2022.01.22  | drm-kmod 要求的多个 LinuxKPI 更改之后的 13.0-STABLE。 |
|    1300526    | [c39ff2415cb9](https://cgit.freebsd.org/src/commit/?id=c39ff2415cb965b729fd16f9eae91e712313877b) | 2022.02.20 | 与 drm-kmod 重叠但不冲突的多个 LinuxKPI 更改之后的 13.0-STABLE。 |
...
|    1301501    | [6663718bb496](https://cgit.freebsd.org/src/commit/?id=6663718bb49635deac3f5dc55fa6f0f7cba593ba) |   2022.03.27   |  13.1-STABLE 在对 LinuxKPI 和 net80211 进行各种合并之后。  |
|    1301502    | [2278cf4e48e7](https://cgit.freebsd.org/src/commit/?id=2278cf4e48e7679b0a60008a83c764fe852174b2) |   2022.04.27   | 13.1-STABLE 在各种合并到 LinuxKPI 之后。 |
|    1301503    | [b2aa64d05bd8](https://cgit.freebsd.org/src/commit/?id=b2aa64d05bd8b04a1bdb63f2a5f9de39c600b463) |    2022.05.19    | 13.1-STABLE 在添加了没有 devclass 参数的备用DRIVER_MODULE宏之后。 |
...
|    1301505    | [6f93a76ffeab](https://cgit.freebsd.org/src/commit/?id=6f93a76ffeabf7d4488edc73a0cca01436c2903b) | 2022.06.21 | 13.1-STABLE 在各种合并到 LinuxKPI 之后。 |
...
|    1301507    | [9cbba5950123](https://cgit.freebsd.org/src/commit/?id=9cbba5950123f3afedcc5f24c43956e7a26f22f4) | 2022.06.21 | 13.1-STABLE 在各种合并到 LinuxKPI 之后。 |
