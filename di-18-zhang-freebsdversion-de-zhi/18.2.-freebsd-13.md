...
|    1300003    |  [340055](https://svnweb.freebsd.org/changeset/base/340055)  |  十一月 2, 2018  | vop_symlink API 改变后的13.0-CURRENT（现在是.）`a_target` `const`。 |
...
|    1300008    |  [342772](https://svnweb.freebsd.org/changeset/base/342772)  |  一月 4, 2019   | 加入和 sysctls.`kern.smp.threads_per_core` `kern.smp.cores`后的 13.0-CURRENT。 |
|    1300009    |  [343213](https://svnweb.freebsd.org/changeset/base/343213)  |  一月 20, 2019  | 为解决 ieee80211com 结构的 ioctl/detach 竞赛而改变结构后的13.0-CURRENT。`结构ieee80211vap`。 |
|    1300010    |  [343485](https://svnweb.freebsd.org/changeset/base/343485)  |  一月 27, 2019  | 13.0-CURRENT 从 63 增加到 (255) 之后。`SPECNAMELEN` `MAXNAMELEN`。 |
...
|    1300012    |  [344062](https://svnweb.freebsd.org/changeset/base/344062)  | 二月 12, 2019  | 13.0-CURRENT 之后，并接受一个设备_t和一个结构资源指针作为参数来表示设备中断。`taskqgroup_attach()` `taskqgroup_attach_cpu()`。 |
|    1300013    |  [344300](https://svnweb.freebsd.org/changeset/base/344300)  | 二月 19, 2019  | 13.0- 删除 drm 和 drm2 之后的电流。 |
...
|    1300020    |  [346358](https://svnweb.freebsd.org/changeset/base/346358)  |   四月 18, 2019   | 恢复了 [random(4)](https://www.freebsd.org/cgi/man.cgi?query=random&sektion=4&format=html) 之前 [346250](https://svnweb.freebsd.org/changeset/base/346250) 的可用性权衡之后的 13.0-CURRENT， 并增加了新的调整项和诊断系统， 以便在启动后以编程方式发现早期播种问题。 |
...
|    1300025    |  [347532](https://svnweb.freebsd.org/changeset/base/347532)  |    五月 13, 2019    | 13.0-CURRENT 在重命名为并改变其类型后，`vm.max_wired` `vm.max_user_wired`。 |
...
|    1300028    |  [347925](https://svnweb.freebsd.org/changeset/base/347925)  |    五月 17, 2019    | 移除 BM、CS、DE、ED、EP、EX、FE、PCN、SF、SN、TL、TX、TPP、VX、WB 和 XE 驱动后的 13.0-CURRENT。 |
...
|    1300063    |  [355537](https://svnweb.freebsd.org/changeset/base/355537)  |  十二月 8, 2019  | 删除 VI_DOOMED 之后的 13.0-CURRENT（用 VN_IS_DOOMED 代替）。 |
...
|    1300122    |  [366782](https://svnweb.freebsd.org/changeset/base/366782)  |  十月 17, 2020  | 加入 `ptsname_r` 之后的 13.0-CURRENT。 |
...
|    1300135    | [35a39dc5b349](https://cgit.freebsd.org/src/commit/?id=35a39dc5b34962081eeda8dbcf0b99a31585499b) |  一月 12, 2021  | 13.0-CURRENT after adding `kernel_fpu_begin`/`kernel_fpu_end` to the LinuxKPI. |
|    1300136    | [72c551930be1](https://cgit.freebsd.org/src/commit/?id=72c551930be195b5ea982c1b16767f54388424f2) |  一月 17, 2021  | 在 fast taskqueue 之上重新实现了 LinuxKPI 的 `irq_work` 队列之后的 13.0-CURRENT。 |
...
|    1300138    | [dcee9964238b](https://cgit.freebsd.org/src/commit/?id=dcee9964238b12a8e55917f292139f074b1a80b2) |  二月 1, 2021  | 13.0-ALPHA3 在为 vfs 缓存添加无锁符号链接查询后。 |
|    1300139    | [91a07ed50ffc](https://cgit.freebsd.org/src/commit/?id=91a07ed50ffca4dfada3e7f1f050ea746c1bac66) |  二月 2, 2021  | 13.0-ALPHA3 在添加各种 LinuxKPI 位后与 drm-kmod 冲突。 |
|    1300500    | [3c6a89748a01](https://cgit.freebsd.org/src/commit/?id=3c6a89748a01869c18955d5e3bfcdf35f6705d26) |  二月 5, 2021  | releng/13.0 被支解后的 13.0-STABLE。 |
|    1300501    | [c3f97dd75a1c](https://cgit.freebsd.org/src/commit/?id=c3f97dd75a1c294c4f60f42b604ee8bcda17be09) |   四月 23, 2021   |     修正了 rtld 的 `dl_iterate_phdr()` 之后的 13.0-STABLE。     |
|    1300502    | [da6a8ccfa293](https://cgit.freebsd.org/src/commit/?id=da6a8ccfa293c3c831fdde51169754fcb9587657) |   四月 23, 2021   | 13.0-STABLE 在 LinuxKPI 中实现了 `atomic_dec_and_lock_irqsave()` 之后。 |
...
|    1300508    | [658f5eed38c3](https://cgit.freebsd.org/src/commit/?id=658f5eed38c35f3f7d6695110b7dae8dc94d12c7) |   六月 11, 2021    | 13.0-STABLE 在 LinuxKPI 中加入了 `might_lock_nested()` 和 `lockdep_(re/un/)pin_lock()` 的宏之后。 |
|    1300509    | [210349325af9](https://cgit.freebsd.org/src/commit/?id=210349325af9920d1535ad76fa3b92847684f6e0) |   六月 14, 2021    | 13.0-STABLE 在 LinuxKPI 中增加了一个宏，即`list_for_each_entry_lockless()`。 |
...
|    1300519    | [fe2827f1678b](https://cgit.freebsd.org/src/commit/?id=fe2827f1678b8ff0baf62a1529b2cc121a25b090) |  十月 21, 2021  | 13.0-STABLE 在 OCF 中扩展了 AES-CCM 和 Chacha20-Poly1305 密码，以支持多种 nonce 长度。 |
...
|    1301503    | [b2aa64d05bd8](https://cgit.freebsd.org/src/commit/?id=b2aa64d05bd8b04a1bdb63f2a5f9de39c600b463) |    五月 19, 2022    | 13.1-STABLE 在添加了没有 devclass 参数的备用DRIVER_MODULE宏之后。 |
