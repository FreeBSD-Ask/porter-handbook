...
| 值 | 修订版 | 日期 | 版本 |
| --- | --- | --- | --- |
| 1200000	 | [302409](https://svnweb.freebsd.org/changeset/base/302409)	 | 2016.07.7	 | 12.0-CURRENT。 |
| 1200001	 | [302628](https://svnweb.freebsd.org/changeset/base/302628)	 | 2016.07.12	 | 移除 `[a-z]` 类型范围的排序之后的 12.0-CURRENT。 |
| 1200002	 | [304395](https://svnweb.freebsd.org/changeset/base/304395)	 | 2016.08.18	 | 移除未使用的、过时的 `openbsd_poll` 系统调用之后的 12.0-CURRENT。 |
...
| 1200018	 | [309676](https://svnweb.freebsd.org/changeset/base/309676)	 | 2016.12.07 	 | 在 `struct kinfo_proc` 和 `struct kinfo_proc32` 中加入 `ki_moretdname` 成员后的 12.0-CURRENT，以便将整个线程名称导出到用户空间的工具。 |
...
| 1200026	 | [315662](https://svnweb.freebsd.org/changeset/base/315662)	 | 2017.03.16	 | 将 `struct inpcb` 和 `struct tcpcb` 隐藏在用户区之后的 12.0-CURRENT。 |
| 1200027	 | [315673](https://svnweb.freebsd.org/changeset/base/315673)	 | 2017.03.21	 | 让 CAM SIM 锁定成为可选项之后的 12.0-CURRENT。 |
| 1200028	 | [316683](https://svnweb.freebsd.org/changeset/base/316683)	 | 2017.04.10	 | 将 [316648](https://svnweb.freebsd.org/changeset/base/316648) 中的 `smp_no_rendevous_barrier()` 改为 `smp_no_rendezvous_barrier()` 之后的 12.0-CURRENT。 |
...
| 1200063	 | [333446](https://svnweb.freebsd.org/changeset/base/333446)	 | 2018.05.10	 | 重新修改 CTL 前端和后端选项以使用 [nv(3)](https://www.freebsd.org/cgi/man.cgi?query=nv&sektion=3&format=html) 之后的 12.0-CURRENT， 允许创建多个 ioctl 前端端口。 |
...
| 1201524	 | [365356](https://svnweb.freebsd.org/changeset/base/365356)	 | 2020.09.05 	 | 将 XDR 分割成一个单独的内核模块， 以减少对 ZFS 的依赖之后的 12-STABLE。 |
