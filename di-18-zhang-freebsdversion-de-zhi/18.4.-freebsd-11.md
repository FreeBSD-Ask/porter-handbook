...
| 1100014	 | [263235](https://svnweb.freebsd.org/changeset/base/263235)	 | 2014.03.16	 | 将 **<sys/capability.h>** 重命名为 **<sys/capsicum.h>** 之后的 11.0-CURRENT， 以避免与其它操作系统中类似的头文件发生冲突。一个兼容性头被保留下来， 以限制构建中断， 但在适当的时候会被废弃。 |
...
| 1100020	 | [265215](https://svnweb.freebsd.org/changeset/base/265215)	 | 2014.05.01	 | 移除 lindev 以支持默认的 /dev/full 之后的 11.0-CURRENT (修订版 265212)。 |
| 1100021	 | [266151](https://svnweb.freebsd.org/changeset/base/266151)	 | 2014.05.06	 | 修改 **src.opts.mk** 之后的 11.0-CURRENT， 将 [make.conf(5)](https://www.freebsd.org/cgi/man.cgi?query=make.conf&sektion=5&format=html) 与 `buildworld` 脱钩 (rev [265419](https://svnweb.freebsd.org/changeset/base/265419))。 |
| 1100022	 | [266904](https://svnweb.freebsd.org/changeset/base/266904)	 | 2014.05.30	 | 修改 [strcasecmp(3)](https://www.freebsd.org/cgi/man.cgi?query=strcasecmp&sektion=3&format=html) 之后的 11.0-CURRENT， 将 [strcasecmp_l(3)](https://www.freebsd.org/cgi/man.cgi?query=strcasecmp_l&sektion=3&format=html) 和 [strncasecmp_l(3)](https://www.freebsd.org/cgi/man.cgi?query=strncasecmp_l&sektion=3&format=html) 从 **<string.h>** 移至 **<strings.h>** 以符合 POSIX 2008 标准 (修订版 [266865](https://svnweb.freebsd.org/changeset/base/266865))。 |
...
| 1100028	 | [268945](https://svnweb.freebsd.org/changeset/base/268945)	 | 2014.07.21	 | [hdestroy(3)](https://www.freebsd.org/cgi/man.cgi?query=hdestroy&sektion=3&format=html) 遵从性修正之后的 11.0-CURRENT， 改变了 ABI。 |
...
| 1102502	 | [338617](https://svnweb.freebsd.org/changeset/base/338617)	 | 2018.09.12	 | 增加了一个套接字选项 SO_TS_CLOCK，并修正了`recvmsg32()` 系统调用，以正确地向下转换64位结构的布局，以符合32位应用程序的期望，之后的11-STABLE。 |
