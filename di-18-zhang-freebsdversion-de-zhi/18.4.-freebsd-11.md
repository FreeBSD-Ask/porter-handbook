...
| 1102502	 | [338617](https://svnweb.freebsd.org/changeset/base/338617)	 | 2018.09.12	 | 增加了一个套接字选项SO_TS_CLOCK，并修正了`recvmsg32()` 系统调用，以正确地向下转换64位结构的布局，以符合32位应用程序的期望，之后的11-STABLE。 |
