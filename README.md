...
**郑重声明：本站所有涉及到“FreeBSD”字样或“freebsd”，均使用了来自美国 FreeBSDFoundation 的商标，与他人无关。我们反对任何形式的滥用商标注册行为！见 [FreeBSD 商标被抢注一事（未解决）](https://book.bsdcn.org/di-0-zhang-freebsd-zhong-wen-she-qu/di-0.5-jie-freebsd-shang-biao-bei-qiang-zhu-yi-shi-wei-jie-jue.html)。**
...
| :--------------------------: | :-----: | :--------: |
|            第1章 简介            | 陈洪翰\_成都 |     已完成    |
|        第2章 制作一个新 port        | 陈洪翰\_成都 |     已完成    |
|         第3章 简单的 port         |   哈哈哈   |     已完成    |
|         第4章 复杂的 Port         |    HF   |     已完成    |
|        第5章 配置 Makefile       |   亲爱的翻译官   | 已完成 |
|           第6章 特殊情况           |  亲爱的翻译官、SimonYen  | 2023.3.24/2023.6.18 |
|          第7章 Flavors         |    冰    |     已完成    |
|      第8章 高级 pkg-plist 实践     |    冰    |     已完成    |
|          第9章 pkg-\*          |    冰    |     已完成    |
|         第10章 测试 port         |    冰    |     已完成    |
|         第11章 升级 port         |    冰    |     已完成    |
|            第12章 安全           |    冰    |     已完成    |
|        第13章 该做什么和不该做什么       |    冰    |     已完成    |
|       第14章 Makefile 示例       |  亲爱的翻译官 |     已完成    |
|  第15章 在 Port Makefile 中变量的顺序 |  亲爱的翻译官 |     已完成    |
|           第16章 保持同步          |  亲爱的翻译官 |     已完成    |
|        第17章 使用 USES 宏        |    冰    |     已完成    |
| 第18章 \_\_FreeBSD\_version 的值 |    冰    | 已完成  |
