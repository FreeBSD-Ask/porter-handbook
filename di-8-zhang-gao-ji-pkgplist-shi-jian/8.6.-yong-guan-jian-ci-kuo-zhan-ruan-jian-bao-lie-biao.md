...
将作为参数传递的文件添加到 plist，并在安装和卸载时更新信息文档索引。此外，在卸载时，如果索引为空，还会删除该索引。永远不要手动使用此项，而应该通过 `INFO` 使用。有关更多信息，请参见 [info 文件](https://docs.freebsd.org/en/books/porters-handbook/makefiles/#makefile-info)。
